...
## Test Results
- ✅ Unit tests passed (Step 5)
- ✅ Code review approved (Step 6)
- ✅ Integration tests passed (Step 8)
- ✅ Final integration test passed (Step 11)

---
🤖 Generated by Claude Code worktree workflow
"""

    # Create PR to main (hardcoded, not dynamic)
    print(f"\n🔄 Creating PR: {branch_name} → {pr_target}")
    try:
        result = subprocess.run(
            [
                'gh', 'pr', 'create',
