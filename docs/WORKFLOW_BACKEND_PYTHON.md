...
> *(Docker projects only)* Docker containers start with unique ports, providing a completely isolated Python environment with a separate database per worktree — no shared resources.
